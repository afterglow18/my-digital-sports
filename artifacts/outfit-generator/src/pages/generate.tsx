...
const LM = {
  ...
  rows: [
    ...
    { sectionTop: 0.733, shelfY: 0.840, btnCY: 0.847 },  // MEMORABILIA panel (row 4)
  ],
          ...
          <>
            ...
            <div style={{
              ...
              <div style={{
                ...
                fontWeight: 900,
                fontSize: Math.max(10, Math.min(pW(ir, 0.040), ir.containerH * 0.028)),
                  ...
                  {items.length > 0 ? (
                    ...
                    >
                      <ClosetRow
                        ...
                        maxPhotoH={Math.max(0, carH - (rowIdx === 3 ? -14 : rowIdx === 0 ? -5 : rowIdx === 1 ? 2 : rowIdx === 2 ? 9 : 6))}
                        pinTop
                        disableSwipe
                      />
                    </div>
            ...
            {/* ── Action bar — nav-bar panel behind buttons ── */}
            <div
              aria-hidden="true"
              style={{
                position: "absolute",
                ...
                {phase === "idle" && !isSaveOpen && (
                  <motion.button
                    ...
                    style={{
                      ...
                      background: hasItems
                        ? "linear-gradient(to bottom, #1e4d9e, #0e2a5c)"
                        : "rgba(30,60,120,0.30)",
                      color: hasItems ? "#fff" : "#8ab",
