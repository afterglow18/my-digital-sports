/**
 * WelcomePage — two-phase splash screen.
 *
 * Phase 1 — "hero"   : Full-screen hero image, auto-advances after 2.5 s (instant cut)
 * Phase 2 — "locker" : Locker doors over the live app. Button opens doors → instant reveal.
 */
...
export default function WelcomePage({ onEnter }: Props) {
  ...
  // Phase 1 → Phase 2: instant cut after 2.5 s
  useEffect(() => {
  ...
  const finish = useCallback(() => {
    ...
    onEnter(); // unmounts this component instantly — app is already behind it
  }, [onEnter]);
  ...
  // Called once when either door finishes — immediately reveal app
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          }}>My Digital Sports</span>
        </div>
      </div>
    );
  }

  // ── Phase 2: locker (app already sits behind this via App.tsx) ─────────────
  return (
    <div style={{
      position: "fixed", inset: 0, zIndex: 200,
      ...
      {/* Door area — transparent background so the app shows through as doors open */}
      <div style={{
        flex: 1,
        position: "relative",
        width: "100%",
        ...
        <div style={{
          ...
          {/* Center lock badge — fades as doors open */}
          <AnimatePresence>
            {!isOpening && (
              <motion.div
                key="seam"
      ...
      {/* Bottom bar — solid dark so it sits cleanly over the app */}
      <div style={{
        flexShrink: 0,
        width: "100%",
        background: "#0d1b2e",
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: 7, height: 52, borderRadius: 4,
